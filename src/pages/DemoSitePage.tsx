...
const SUPPORT_SCENARIOS = [
  {
    title: 'Billing issue',
    body: 'If an invoice keeps failing, your account is charged incorrectly, or you need finance to follow up, send the details through chat. Nimbus support will review the account and follow up by email when needed.',
    prompt:
  ...
  },
  {
    ...
    body: 'If receipt upload, bank sync, QuickBooks/Xero sync, or recurring billing stops working, describe what you were trying to do and the error you saw. Nimbus support can troubleshoot from the conversation and escalate when the fix needs an engineer.',
    prompt:
      'QuickBooks sync has failed three times today and my invoices are not updating. Can support investigate and follow up?',
  },
]
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-slate-600 leading-relaxed">
            ...
            <section
              ...
              className="px-6 py-24 bg-white border-b border-slate-200"
            >
              <div className="mx-auto max-w-4xl">
                <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 text-center">
                  Support scenarios
                ...
                <h2 className="mt-3 text-center text-3xl md:text-4xl font-bold tracking-tight">
                  Need help with billing or a technical issue?
                </h2>
                <p className="mx-auto mt-4 max-w-2xl text-center text-slate-600 leading-relaxed">
                  Use the chat bubble in the bottom-right corner and describe the issue in your own
                  words. These are realistic examples of the kind of support request Nimbus handles.
                </p>
                <div className="mt-10 grid gap-6 md:grid-cols-2">
                  {SUPPORT_SCENARIOS.map((scenario) => (
                    ...
                    >
                      <h3 className="text-base font-bold tracking-tight">{scenario.title}</h3>
                      <p className="mt-2 text-sm text-slate-600 leading-relaxed">{scenario.body}</p>

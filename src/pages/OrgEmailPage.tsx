      ...
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl font-extrabold tracking-tight text-gray-900">Email Settings</h1>
            <p className="mt-1 text-sm text-gray-400">
              Configure how Lira sends emails to your team.
            </p>
          </div>
          <button
            onClick={handleSave}
          ...
          <div className="space-y-4 px-5 py-5">
            <div>
              ...
              <p className="mt-1.5 text-xs text-gray-400">
                ...
                <em>{fromName || 'Lira AI'} &lt;lira@liraintelligence.com&gt;</em>
              </p>
            </div>
            ...
            <div className="flex items-center gap-2.5 rounded-xl border border-gray-100 bg-gray-50 px-4 py-3">
              ...
              <p className="text-xs text-gray-600">
                {hasDomain && config?.domain_verified ? (
                  <>
                    Sending as{' '}
                    <span className="font-semibold text-gray-800">lira@{config.custom_domain}</span>
                  </>
                ) : (
                  <>
                    Sending from <span className="font-semibold">lira@liraintelligence.com</span>.{' '}
                    Set up a custom domain below to send from your own address.
                  </>
                )}
              </p>
            </div>
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  {registering ? 'Registering…' : dnsRecords.length ? 'Re-register' : 'Register'}
                </button>
              </div>
              <p className="text-xs text-gray-400">
                Enter the root domain — Lira will send as <em>lira@yourcompany.com</em>. You'll need
                access to your DNS provider to complete setup.
              </p>
            </div>
              ...
              <div className="space-y-3">
                <div className="rounded-xl border border-amber-100 bg-amber-50 px-4 py-3">
                  ...
                  <p className="text-xs text-amber-700">
                    Log in to your domain registrar (e.g. Cloudflare, GoDaddy, Route 53, Namecheap)
                    and add the following DNS records exactly as shown. Propagation typically takes
                    5–30 minutes.
                  </p>
                </div>
                ...
                <p className="text-xs text-gray-400">
                  ...
                  cPanel) strip the root domain from the Name field automatically — if your record
                  name already includes your domain, enter only the subdomain part shown above.
                </p>
                ...
                <div className="flex items-center justify-between gap-3 rounded-xl border border-gray-100 bg-gray-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      Once DNS records are added, click Verify. This polls Resend every 8 seconds.
                    </p>
                  </div>
                  <button

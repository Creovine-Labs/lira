      ...
      >
        <header className="dem-header">
          ...
          <p className="dem-meta">
            We've built a fictional company called <strong>Nimbus</strong> so you can experience
            Lira in a realistic context.
          </p>
        </header>
        ...
        >
          ...
          <button type="button" className="dem-back" onClick={onClose} disabled={submitting}>
            ← Go back to Lira
          </button>
        </form>
      </div>

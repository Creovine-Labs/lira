...
// load fetches a fresh bundle. Critical when iterating on the widget locally
// because the IIFE is loaded as a regular <script src>, which is otherwise
// happily cached by the browser across sessions.

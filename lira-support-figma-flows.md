...
- Fallback behavior: "If a variable is missing, use: ___"
...
*Document complete — 47 screens, 10 flows, full integration architecture, design system guidance, and API endpoint inventory.*
*Ready for Figma.*
